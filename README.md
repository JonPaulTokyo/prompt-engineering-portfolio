...
**Turning Complex Articles into Clear, Structured JSON**
...
### Purpose
- Demonstrate advanced prompt engineering techniques (structured JSON output, consistent schemas, accurate extraction)
- Simplify and organize knowledge about Jain culture, families, history, practices, and modern life
- Build a growing knowledge base about Jain subject families
